...
test('operations users can import approved processor reports from either workbook', function () {
    ...
    $response = $this->actingAs($user)->post('/operations/reports/import', [
        'entries' => json_encode([
            ...
            ['source' => 'closed', 'project_id' => '10006', 'insured_by' => 'Sample insured', 'inspection_type' => 'Premium 4-Point Inspection', 'assembled_by' => 'Jhun Cervantes', 'assembled_at' => '08/31/2026 10:45'],
    ...
    $response->assertSessionHas('importSummary', ['saved' => 5, 'ignored' => 1]);
    $this->get(route('operations.reports'))->assertInertia(fn (Assert $page) => $page
        ...
        ->where('flash.importSummary', ['saved' => 5, 'ignored' => 1]));
    ...
    $this->assertDatabaseHas('report_entries', ['source' => 'closed', 'batch' => 1, 'processor_name' => 'Jhun Cervantes', 'project_id' => '10006', 'report_category' => 'premium_four_point']);
